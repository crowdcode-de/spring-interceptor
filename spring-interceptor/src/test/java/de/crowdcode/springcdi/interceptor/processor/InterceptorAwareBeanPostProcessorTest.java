...
public class InterceptorAwareBeanPostProcessorTest {
	...
	public void setUp() throws Exception {
		processor = new InterceptorAwareBeanPostProcessor(
				new InterceptorMetaDataBean(
						new SimpleInterceptorResolutionStrategy()
								.resolveRegisteredInterceptors(beanFactory)),
				(ConfigurableListableBeanFactory) beanFactory);
	}

	@Test
	public void testProxying() throws Throwable {
		Simple_MyServiceInterface_Impl simple_MyServiceInterface_Impl = (Simple_MyServiceInterface_Impl) processor
				.postProcessAfterInitialization(
						beanFactory.getBean("simple_MyServiceInterface_Impl"),
						"simple_MyServiceInterface_Impl");
		Assert.assertTrue(AopUtils.isCglibProxy(simple_MyServiceInterface_Impl));
	}

	// TODO Java Runtime Error: Heap Space!
	// @Test
	public void testWorkingInterceptor() throws Throwable {
		Simple_MyServiceInterface_Impl simple_MyServiceInterface_Impl = (Simple_MyServiceInterface_Impl) processor
				.postProcessAfterInitialization(
						beanFactory.getBean("simple_MyServiceInterface_Impl"),
						"simple_MyServiceInterface_Impl");
		Assert.assertTrue(simple_MyServiceInterface_Impl.sayGoodBye().equals(
				"Good bye_hello_world"));
		Assert.assertTrue(simple_MyServiceInterface_Impl.sayHello().equals(
				"Hello_hello_world"));
		Assert.assertTrue(simple_MyServiceInterface_Impl.sayHello("Geek")
				.equals("Geek_hello_world"));
	}
